...
// 建议修改为自己的 UUID
let userID = '994b26a7-a529-4ed0-bb55-6c99381b52e6';

// 生成配置文件的 CF 优选 IP
const bestCFIP = "qsign-hf.api.luoyutianyang.icu"
...
// let proxyIP = proxyIPs[Math.floor(Math.random() * proxyIPs.length)]; // '157.254.21.56'; //
let proxyIP = '1.0.0.1'
...
function getVLESSConfig(userID, hostName) {
    const vlessLink = `vless://${userID}\u0040${bestCFIP}:80?encryption=none&security=none&fp=randomized&type=ws&host=${hostName}&path=%2F%3Fed%3D2560#Hanahime_Workers`
    const vlessTlsLink = `vless://${userID}\u0040${bestCFIP}:443?encryption=none&security=tls&sni=${hostName}&fp=randomized&type=ws&host=${hostName}&path=%2F%3Fed%3D2560#Hanahime_Workers-TLS`
    return `
...
function getBase64Config(userID, hostName) {
    const vlessLinks = btoa(`vless://${userID}\u0040${bestCFIP}:443?encryption=none&security=tls&sni=${hostName}&fp=randomized&type=ws&host=${hostName}&path=%2F%3Fed%3D2560#Hanahime_CF_VLESS-TLS-443\nvless://${userID}\u0040${bestCFIP}:2053?encryption=none&security=tls&sni=${hostName}&fp=randomized&type=ws&host=${hostName}&path=%2F%3Fed%3D2560#Hanahime_CF_VLESS-TLS-2053\nvless://${userID}\u0040${bestCFIP}:2083?encryption=none&security=tls&sni=${hostName}&fp=randomized&type=ws&host=${hostName}&path=%2F%3Fed%3D2560#Hanahime_CF_VLESS-TLS-2083\nvless://${userID}\u0040${bestCFIP}:2087?encryption=none&security=tls&sni=${hostName}&fp=randomized&type=ws&host=${hostName}&path=%2F%3Fed%3D2560#Hanahime_CF_VLESS-TLS-2087\nvless://${userID}\u0040${bestCFIP}:2096?encryption=none&security=tls&sni=${hostName}&fp=randomized&type=ws&host=${hostName}&path=%2F%3Fed%3D2560#Hanahime_CF_VLESS-TLS-2096\nvless://${userID}\u0040${bestCFIP}:8443?encryption=none&security=tls&sni=${hostName}&fp=randomized&type=ws&host=${hostName}&path=%2F%3Fed%3D2560#Hanahime_CF_VLESS-TLS-8443`);
